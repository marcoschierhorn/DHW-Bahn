<div class="clearfix">
  ...
  <div class="clearfix matrix">
    <label>ist eine gute Alternative für spontane Reisen</label><?php echo $form['spontan']->render();?>
  </div>
