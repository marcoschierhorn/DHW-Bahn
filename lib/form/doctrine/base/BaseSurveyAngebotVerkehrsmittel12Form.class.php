...
/**
 * SurveyAngebotVerkehrsmittel12 form base class.
 *
 * @method SurveyAngebotVerkehrsmittel12 getObject() Returns the current form's model object
 *
 * @package    bahn
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseSurveyAngebotVerkehrsmittel12Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('survey_angebot_verkehrsmittel12[%s]');
  ...
  {
    return 'SurveyAngebotVerkehrsmittel12';
  }
