...
/**
 * SurveyAnlaesse form base class.
 *
 * @method SurveyAnlaesse getObject() Returns the current form's model object
 *
 * @package    bahn
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseSurveyAnlaesseForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('survey_anlaesse[%s]');
