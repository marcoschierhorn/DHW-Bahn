 ...
 * @version    SVN: $Id$
 */
class dhwValidatorNames extends sfValidatorSchema
{
  /**
   * Constructor.
   *
  ...
  protected function configure($options = array(), $messages = array())
  {
    ...
    $this->setMessage('invalid', 'Sie haben sich schon für das Gewinnspiel registriert.');
  }
  ...
  protected function doClean($values)
  {
    ...
    foreach ($this->getOption('column') as $column)
    {
      ...
      $q->addWhere('LOWER(a.' . $colName . ') = ?', strtolower(trim($values[$column])));
    }
